...
const defaultArgs = {
  ...
  body: '<em>To serve up</em> an <strong>impressive</strong> dish of <a>roasted red snapper, we started by making shallow slashes</a> in the skin to ensure even cooking and seasoning; this step also allowed us to gauge the doneness of the fish easily.',
  siteKey: 'atk',
};
